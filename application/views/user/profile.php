                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="form-control-label">Nama Masjid</label>
                                    <input class="form-control" name="name_masjid" id="name_masjid" type="text" value="<?= $user['name_masjid']; ?>">
                                    <?= form_error('name_masjid', '<small class="text-danger" pl-3>', '</small>'); ?>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
